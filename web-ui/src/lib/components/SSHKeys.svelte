    ...
    <div class="ssh-keys-content">
        <div class="section-header">
            <p class="section-description">
                SSH keys allow you to connect to your terminals securely without
                a password.
            </p>
            <button
        ...
        {:else if $isGuest}
            <div class="guest-state">
                ...
                <p>
                    Sign in with PipeOps to manage your SSH keys and enable
                    secure passwordless access to your terminals.
                </p>
                <button
                    class="btn btn-primary"
        ...
        {:else if keys.length === 0}
            <div class="empty-state">
                ...
                <h2>No SSH Keys</h2>
                <p>
                    Add an SSH key to enable secure passwordless access to your
                    terminals.
                </p>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <span class="form-hint">
                        Paste your public key (usually from
