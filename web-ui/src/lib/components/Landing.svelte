...
<div class="landing">
  <div class="landing-content">
    ...
    <p class="description">
      Launch isolated containers with full shell access. No setup required.
      Choose from Ubuntu, Debian, Alpine, Fedora, and more.
    </p>
    ...
    <div class="terminal-preview">
      ...
      <div class="terminal-preview-body">
        ...
        <div class="terminal-output">Linux rexec 6.5.0-44-generic #44-Ubuntu SMP x86_64 GNU/Linux</div>
        <div class="terminal-line">
          <span class="prompt">root@rexec:~#</span>
