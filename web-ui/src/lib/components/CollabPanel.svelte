...
{#if isOpen}
  ...
  <div class="panel-overlay" on:click|self={close} transition:fade={{ duration: 150 }}>
      ...
      <div class="panel-body">
          ...
          <div class="start-view" in:fade={{ duration: 200 }}>
            ...
            <div class="section">
              <div class="slider-header">
                <span class="section-label">Max Participants</span>
        ...
        {:else}
          ...
          <div class="active-view" in:fade={{ duration: 200 }}>
            <div class="live-banner" class:control={mode === 'control'}>
              <span class="live-indicator">
                <span class="pulse-dot"></span>
                LIVE
              </span>
              <span class="session-mode">
                {mode === 'control' ? 'Full Control Enabled' : 'View Only Mode'}
              </span>
            </div>
            ...
            <div class="section participants-section">
              <div class="section-header">
                ...
                <span class="p-count">{participants.length} / {maxUsers}</span>
              </div>
              
              <div class="participants-list">
                {#each participants as p}
                  <div class="participant-row">
                    <div class="p-avatar" style="background-color: {p.color}">{p.username.slice(0, 1).toUpperCase()}</div>
                    <div class="p-info">
                      <span class="p-name">
                        {p.username}
                        {#if p.role === 'owner'}<span class="p-badge owner">HOST</span>{/if}
                      </span>
