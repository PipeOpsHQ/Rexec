...
export const defaultRoles: Role[] = [
    ...
    { id: "devops", name: "YAML Herder", description: "I don't write code, I write config. AI assists.", icon: "☸️", packages: ["zsh", "git", "docker", "kubectl", "ansible", "terraform", "tgpt", "aichat", "mods", "zsh-autosuggestions", "zsh-syntax-highlighting"] },
